...
FASTQS_DIR="$DATA_DIR/processed/OVA_receptor/hmmersearch_alignment_outputs/fastq_subsets/R1"
...
for file in $FASTQS_DIR/*{GEX,VDJ}*R1.fq.gz; do #{GEX,VDJ} for both VDJ and GEX
