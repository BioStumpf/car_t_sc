...
###LoadFileFrom10X
data <- Read10X("/path/to/cellranger/raw_feature_bc_matrix/")
#createSeuratObject
seurat_obj1 <- CreateSeuratObject(counts=data_P1$'Gene Expression')
seurat_obj1[['HTO']] <- CreateAssayObject(counts=data_P1$'Antibody Capture')
