#!/bin/bash
#SBATCH --job-name=cellranger_P1_CSP_GEX
...
cd /home/s377963/car_t_sc/01_data/raw/cellranger_CSP_GEX || exit
...
/home/s377963/cellranger/cellranger-8.0.1/bin/cellranger count \
  ...
  --libraries /home/s377963/car_t_sc/02_code/cellranger_jobs/library_CSVs/GEX_CSP/P1.csv \
  --chemistry SC5P-R2
